 ...
 * 2017-12-29T22:40:47.031+08:00
 * Generated source version: 2.5.9
 * 
 */
@WebServiceClient(name = "WeatherWS", 
                  wsdlLocation = "file:/e:/WeatherWS.wsdl",
...
public class WeatherWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/e:/WeatherWS.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWS.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/e:/WeatherWS.wsdl");
        }
        WSDL_LOCATION = url;
    }
